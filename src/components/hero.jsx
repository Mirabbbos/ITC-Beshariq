  ...
  return (
    <div className="w-full h-[100vh] mt-40">
      <div className=" z-10 my-auto w-full h-full justify-around items-center flex ">
        <div className="over- md:flex hidden bg-green-600 min-[1650px]:ml-[-260px] min-[1310px]:ml-[-180px] ml-[-80px] w-[500px] h-[500px] rounded-[100px] border-[18px] border-gray-800 rotate-45 itccccc justify-center items-center ">
        ...
        <div
          data-aos="fade-left"
          className="ml-4 mr-4 pt-[300px]  md:pt-0 md:pl-[80px]"
        >
          <div className="flex items-center gap-3 mt-[40px]">
            <div className="IconsCourse border-[8px] bg-green-600 border-gray-800 text-gray-900 rounded-3xl p-2 h-[80px] w-[80px] justify-center items-center flex rotate-[45deg]">
          ...
          >
            <div className="md:ml-[50px] ml-0 bg-green-600 IconsCourse border-[8px] border-gray-800 text-gray-900 rounded-3xl p-2 h-[80px] w-[80px] justify-center items-center flex rotate-[45deg]">
